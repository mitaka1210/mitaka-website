...
import iconHTML from "../../../assets/images/html-5-svgrepo-com.svg";
import JavascriptIcon from "@mui/icons-material/Javascript";
import rxjs from "../../../assets/images/rxjs-1.svg";
import CSS from '../../../assets/images/css3-svgrepo-com.svg'
import PostgreSQL from "../../../assets/images/postgresql.svg";
import AngularJS from "../../../assets/images/angular-js.svg";
import Angular from "../../../assets/images/angular-svgrepo-com.svg";
import ReactIcon from "../../../assets/images/reactjs-svgrepo-com.svg";
import Nextjs from "../../../assets/images/next-js-svgrepo-com.svg";
import SCSS from "../../../assets/images/sass-svgrepo-com.svg";
import Gulp from "../../../assets/images/gulp-svgrepo-com.svg";
          ...
          <section className="section">
            <div className="flex-horizontal-container justify-content-center rotate-skills">
              <div className="v-boxes section-6">
                ...
                <div className="box">
                  <span className="tooltip">Express Server</span>
                  <div className="box-face">
                    <div className="box-text">
              ...
              <div className="v-boxes section-5">
                <div className="box">
                ...
                <div className="box">
                  <span className="tooltip">Redux(RTK)</span>
                  <div className="box-face">
                    <div className="box-text">
                      <div className="svg-rxjs">
                ...
                <div className="box">
                  <span className="tooltip">RxJs</span>
                  <div className="box-face">
                    <div className="box-text">
                      <div className="svg-rxjs">
              ...
              <div className="v-boxes">
                ...
                <div className="box">
                  <span className="tooltip">AngularJs</span>
                  <div className="box-face">
                    <div className="box-text">
                      <div className="svg-angular-js">
                ...
                <div className="box">
                  <span className="tooltip">Gulp</span>
                  <div className="box-face">
                    <div className="box-text">
                      <div className="svg-gulp">
              ...
              <div className="v-boxes forth">
                <div className="box link">
                  <div className="box-face">
                    <div className="box-text">
                        <div className="svg-html">
                            <Image className="main-html-img" src={iconHTML} alt="iconHTML"/>
                        </div>
                    </div>
                  </div>
                </div>
