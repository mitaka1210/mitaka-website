   ...
   <div className="min-h-screen bg-white grid place-content-center p-5 blog-category-container">
    ...
    <div className="grid lg:grid-cols-3 gap-1 justify-center">
     ...
     <div className="max-w-sm shadow-xl relative card rounded-md overflow-hidden" onClick={() => redirectTo('programing')}>
      <div className="relative">
       <img src="https://images.unsplash.com/photo-1485856407642-7f9ba0268b51?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Wedding" className="max-w-full" />
       <div className="custom-shape-divider-bottom-1635508836">
        <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
         <path d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z" className="shape-fill"></path>
        </svg>
